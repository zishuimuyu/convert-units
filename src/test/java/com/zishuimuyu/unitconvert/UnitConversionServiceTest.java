...
class UnitConversionServiceTest {
    ...
    void testPartialLoading() {
        ...
        com.zishuimuyu.unitconvert.config.UnitConversionConfig config = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfig.partialLoading("length", "mass");
    ...
    void testExcludeUnits() {
        // 创建单位排除配置：排除海里和英寻单位
        com.zishuimuyu.unitconvert.config.UnitConversionConfig config = 
            new com.zishuimuyu.unitconvert.config.UnitConversionConfig.Builder()
    ...
    void testDefaultConfig() {
        // 创建默认配置：加载所有测量类型和单位
        com.zishuimuyu.unitconvert.config.UnitConversionConfig config = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfig.defaults();
    ...
    void testPartialLoadingConvertToBest() {
        // 创建部分加载配置：只包含长度测量类型
        com.zishuimuyu.unitconvert.config.UnitConversionConfig config = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfig.partialLoading("length");
    ...
    void testPartialLoadingListUnitsByMeasure() {
        ...
        // 获取长度单位（应该有结果）
        List<com.zishuimuyu.unitconvert.model.UnitDescription> lengthUnits = 
            partialService.listUnitsByMeasure("length");
        assertFalse(lengthUnits.isEmpty(), "应该能获取到长度单位");
        
        // 获取体积单位（应该没有结果）
        List<com.zishuimuyu.unitconvert.model.UnitDescription> volumeUnits = 
            partialService.listUnitsByMeasure("volume");
    ...
    void testConfigValidatorValidConfig() {
        ...
        // 验证配置
        com.zishuimuyu.unitconvert.config.UnitConversionConfigValidator.ValidationResult result = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfigValidator.validate(config);
    ...
    void testConfigValidatorInvalidMeasure() {
        // 尝试创建包含无效测量类型的配置
        com.zishuimuyu.unitconvert.config.UnitConversionConfig.Builder builder = 
            new com.zishuimuyu.unitconvert.config.UnitConversionConfig.Builder()
                .partialLoading(true)
    ...
    void testConfigValidatorPartialLoadingWithoutMeasures() {
        ...
        com.zishuimuyu.unitconvert.config.UnitConversionConfig config = builder.build();
    ...
    void testConfigUtilsGetAvailableMeasures() {
        // 获取所有可用的测量类型
        java.util.Set<String> measures = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfigUtils.getAvailableMeasures();
    ...
    void testConfigUtilsGetUnitsByMeasure() {
        // 获取长度测量类型的所有单位
        java.util.Set<UnitEnum> lengthUnits = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfigUtils.getUnitsByMeasure("length");
    ...
    void testConfigUtilsCreateLengthOnlyConfig() {
        // 创建长度专用配置
        com.zishuimuyu.unitconvert.config.UnitConversionConfig config = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfigUtils.createLengthOnlyConfig();
    ...
    void testConfigUtilsCreateCommonUnitsConfig() {
        // 创建常用单位配置
        com.zishuimuyu.unitconvert.config.UnitConversionConfig config = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfigUtils.createCommonUnitsConfig();
    ...
    void testConfigUtilsCreateMetricOnlyConfig() {
        // 创建排除英制单位的配置
        com.zishuimuyu.unitconvert.config.UnitConversionConfig config = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfigUtils.createMetricOnlyConfig();
    ...
    void testConfigUtilsValidateAndPrint() {
        ...
        // 验证配置并打印结果
        com.zishuimuyu.unitconvert.config.UnitConversionConfigValidator.ValidationResult result = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfigUtils.validateAndPrint(config);
    ...
    void testConfigUtilsGetConfigStatistics() {
        ...
        // 获取配置统计信息
        String statistics = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfigUtils.getConfigStatistics(config);
    ...
    void testConfigUtilsSuggestConfig() {
        // 测试国际化场景
        com.zishuimuyu.unitconvert.config.UnitConversionConfig internationalConfig = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfigUtils.suggestConfig("international");
        assertNotNull(internationalConfig, "国际化配置不能为null");
        
        // 测试公制场景
        com.zishuimuyu.unitconvert.config.UnitConversionConfig metricConfig = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfigUtils.suggestConfig("metric");
        assertNotNull(metricConfig, "公制配置不能为null");
        
        // 测试简单场景
        com.zishuimuyu.unitconvert.config.UnitConversionConfig simpleConfig = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfigUtils.suggestConfig("simple");
    ...
    void testConfigUtilsCreateCombinedConfig() {
        ...
        // 创建组合配置
        com.zishuimuyu.unitconvert.config.UnitConversionConfig config = 
            com.zishuimuyu.unitconvert.config.UnitConversionConfigUtils.createCombinedConfig(
